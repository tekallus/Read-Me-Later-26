...
export default function App() {
  ...
  /* Challenge
    ...
    Her makale için dört buton çalışmıyor. Göreviniz bunları aşağıdaki gibi ayarlamaktır: 
 ...
 */
  function handleButtonClick(buttonType, idValue) {
    const targetArticle = getTargetArticle(idValue)
    ...
    <div className="wrapper">
      ...
      <div
        ...
        onClick={(event) => {
          ...
          if (targetButton) {
            // Tıklanan öğe bir butonsa ilgili fonksiyonu çağır
            const buttonType = targetButton.dataset['buttonType']
            const articleId = targetButton.dataset['articleId']
            handleButtonClick(buttonType, articleId)
          }
        }}
      >
